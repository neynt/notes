...
- Divide and conquer: Sort points and recurse into left and right halves.
  - The globally closest pair either crosses the median line or it doesn't.
  - If it doesn't, you're good.
  - If it does, the points must be at most $\delta$ apart where $\delta$ is the distance of the closer of the two subsolutions. Consider the $2\delta$-wide strip around the dividing line. TO BE CONTINUED
