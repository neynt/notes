...
Consider any optimal solution, and show that it can be transformed into the greedy solution by a sequence of steps, each of which don't make the solution any worse.
