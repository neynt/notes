...
- Singleton: You can only have one of a class, and you can get it from anywhere.
- Factory Method: Creator creates instances
- Abstract Factory: Abstract class with several concrete factories
- Builder: Takes parts and builds an object
- Prototype: Concrete prototypes and cloning
...
- Facade
  - Facade provides unified interface to multiple possible implementations
...
- Behavioral patterns within a class
