...
- 10.5: Preventing optimization problems.
  - Race free: code that 
  - Two approaches:
    - ad hoc: muh pragmas, not portable but optimal
    - formal: memory model; baroque, suboptimal

- we jumping ahead because no time
...
- 11.4: Concurrency languages
  - 11.4.1: Ada
    ...
    - Used to be very good. Then people kept shoveling random stuff into it. Like C++ today.
  ...
  - 11.4.2: SR / Concurrent C++
    - Didn't have condition variables or requeue, but DID have external scheduling and accept
...
- I've made you concurrently dangerous.
  - You need more experience before you write Airbus A380 code.
